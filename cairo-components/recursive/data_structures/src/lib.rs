...
use crate::{
    fiat_shamir::{
        BlakeContextClaimVar, BuiltinsClaimVar, ChannelU22Var, ChannelU64Var,
        MemoryIdToBigClaimVar, OpcodeClaimVar, PublicDataVar,
    },
...
impl AllocVar for CairoClaimVar {
    fn new_variables(cs: &ConstraintSystemRef, value: &Self::Value, mode: AllocationMode) -> Self {
        ...
        let verify_instruction =
            ChannelU22Var::new_variables(cs, &(value.verify_instruction.log_size as u32), mode);
        ...
        let memory_address_to_id =
            ChannelU22Var::new_variables(cs, &(value.memory_address_to_id.log_size as u32), mode);
